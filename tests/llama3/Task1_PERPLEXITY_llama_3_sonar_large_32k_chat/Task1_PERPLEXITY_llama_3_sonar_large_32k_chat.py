import pytest
from output.llama3.Task1_PERPLEXITY_llama_3_sonar_large_32k_chat import number_of_people_still_on_bus as bus_stops  # Adjust the import path as necessary
